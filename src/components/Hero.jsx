...
import { FileTranslateInput } from "./FileTranslateInput";
  ...
  const handleTranslate = async () => {
    ...
    if (!apiKey) {
      Swal.fire({
        ...
        footer:
          '<a href="/subscription-plan" class="text-white hover:bg-blue-500/70 bg-blue-500 p-3">Create an API key</a>',
      });
      setIsLoading(false);
      return;
    }
      ...
      <div className="flex flex-col gap-2 w-full">
        ...
        {activeTab === "text" ? (
          ...
          <FileTranslateInput
            ...
            languages={languages}
            selectedOutputLanguageName={selectedOutputLanguageName}
            user={user}
            handleOutputDropdownToggle={handleOutputDropdownToggle}
            showOuputLanguageDropdown={showOuputLanguageDropdown}
